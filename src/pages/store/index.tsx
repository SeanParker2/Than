...
export default function Store() {
  ...
  return (
    <>
      <Head>
        <title>设计商店 - Than Studio | 精选设计产品·家居用品·创意商品</title>
        <meta name="description" content="Than Studio设计商店，精选优质设计产品，包含家具、灯具、装饰品、餐具等多种创意商品。为您的生活空间注入艺术气息，体验设计之美。" />
        <meta name="keywords" content="Than Studio,设计商店,设计产品,家具,灯具,装饰品,餐具,创意商品,北欧风格,日式设计" />
        <meta property="og:title" content="设计商店 - Than Studio" />
        <meta property="og:description" content="精选设计产品，为您的生活空间注入艺术气息。" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://seanparker2.github.io/Than/store/" />
        <meta property="og:image" content="https://seanparker2.github.io/Than/images/store.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="设计商店 - Than Studio" />
        <meta name="twitter:description" content="精选设计产品，为您的生活空间注入艺术气息。" />
        <meta name="twitter:image" content="https://seanparker2.github.io/Than/images/store.png" />
        <link rel="canonical" href="https://seanparker2.github.io/Than/store/" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Store",
              "name": "Than Studio 设计商店",
              "description": "精选设计产品，为您的生活空间注入艺术气息",
              "url": "https://seanparker2.github.io/Than/store/",
              "image": "https://seanparker2.github.io/Than/images/store.png",
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "设计产品目录",
                "itemListElement": products.map((product, index) => ({
                  ...
                  "itemOffered": {
                    ...
                    "image": `https://seanparker2.github.io/Than${product.image}`,
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            {/* 统计数据 */}
            <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto transform transition-all duration-1000 delay-300 four-column-stats ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            {filteredProducts.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 store-grid">
